...
//Camera
Camera camera(glm::vec3(0.0f, 20.0f, 6.0f)); // 0.0, 10.0, 3.0f
...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Pratica 5 2025-2", NULL, NULL);
	if (window == NULL) {
	...
	Model casa("resources/objects/casaBrujas/CasaBrujas.obj");

	// añadir 5 objetos estáticos
	Model extin("resources/objects/Extintor/Fire-e.obj");
	Model chair("resources/objects/Silla/chair.obj");
	Model monitor("resources/objects/Monitor/monitor.glb");
	// Model rifle("resources/objects/Rifle/M91.fbx");
	Model pistola("resources/objects/Pistola/Pistol_PM.obj");
	Model bala("resources/objects/Pistola/Bullet.obj");

	ModelAnim animacionPersonaje("resources/objects/Personaje1/Arm.dae");
	animacionPersonaje.initShaders(animShader.ID);

	ModelAnim maynard("resources/objects/Taunt/Taunt.dae");
	maynard.initShaders(animShader.ID); // almacena info de animaciones en memoria

	// segundo personaje de mixamo
	ModelAnim romero("resources/objects/Romero/romero.dae");
	romero.initShaders(animShader.ID); // almacena info de animaciones en memoria
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// -------------------------------------------------------------------------------------------------------------------------
		modelOp = glm::translate(glm::mat4(1.0f), glm::vec3(-40.3f, 1.75f, 1.0f));
		modelOp = glm::scale(modelOp, glm::vec3(0.1f));
		animShader.setMat4("model", modelOp);
		maynard.Draw(animShader);

		modelOp = glm::translate(glm::mat4(1.0f), glm::vec3(-40.3f, 1.75f, 3.0f));
		modelOp = glm::scale(modelOp, glm::vec3(0.1f));	
		animShader.setMat4("model", modelOp);
		romero.Draw(animShader);
		...
		*/
		...
		modelOp = glm::translate(glm::mat4(1.0f), glm::vec3(-30.0f, 20.0f, -10.0f));
		modelOp = glm::rotate(modelOp, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		modelOp = glm::scale(modelOp, glm::vec3(4.0f));
		staticShader.setMat4("model", modelOp);
		extin.Draw(staticShader);

		modelOp = glm::translate(glm::mat4(1.0f), glm::vec3(35.0f, 0.0f, -10.0f));
		modelOp = glm::rotate(modelOp, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		modelOp = glm::scale(modelOp, glm::vec3(0.5f));
		staticShader.setMat4("model", modelOp);
		chair.Draw(staticShader);

		modelOp = glm::translate(glm::mat4(1.0f), glm::vec3(35.0f, 2.0f, 20.0f));
		modelOp = glm::rotate(modelOp, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		modelOp = glm::scale(modelOp, glm::vec3(5.0f));
		staticShader.setMat4("model", modelOp);
		monitor.Draw(staticShader);

		modelOp = glm::translate(glm::mat4(1.0f), glm::vec3(35.0f, 2.0f, 25.0f));
		modelOp = glm::rotate(modelOp, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		modelOp = glm::scale(modelOp, glm::vec3(5.0f));
		staticShader.setMat4("model", modelOp);
		pistola.Draw(staticShader);

		modelOp = glm::translate(glm::mat4(1.0f), glm::vec3(35.0f, 0.5f, 25.0f));
		modelOp = glm::rotate(modelOp, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		modelOp = glm::scale(modelOp, glm::vec3(10.0f));
		staticShader.setMat4("model", modelOp);
		bala.Draw(staticShader);

		/*modelOp = glm::translate(glm::mat4(1.0f), glm::vec3(35.0f, 2.0f, 20.0f));
		modelOp = glm::rotate(modelOp, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		modelOp = glm::scale(modelOp, glm::vec3(5.0f));
		staticShader.setMat4("model", modelOp);
		rifle.Draw(staticShader);*/
